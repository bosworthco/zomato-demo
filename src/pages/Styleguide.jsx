    ...
    <main className="App">
      <section className="StyleBlock StyleBlock--type">
        <div className="Container">
          ...
          <h3 className="u-textBold">Lorem ipsum dolor sit amet.</h3>
          <h3>Lorem ipsum dolor sit amet.</h3>
          <h4 className="u-textBold">Lorem ipsum dolor sit amet.</h4>
          <h4>Lorem ipsum dolor sit amet.</h4>
          <h5 className="u-textBold">Lorem ipsum dolor sit amet.</h5>
